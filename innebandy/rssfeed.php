...
class AllData_class {
	var $lastDate, $messages, $events, $updateFlag;
	...
	function _queryEvents(){
		...
		$confirmations = $this->_Confirmed($teamId,'2');
	...
	*/
	function GetAllData(){
		...
		$sourceTag = Tag("source",$source, "url=\"$sourceUrl\"", false, false);
