...
<body background="images/Background2.jpg" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr> 
    <td width="120">&nbsp;</td>
    <td><font size="+1"><?php echo $teamName; ?> | <a href="http://www.innebandy.no/regelv.shtml" target="_top">Regler</a> 
      | <?php echo RSSlink(); ?> | <a href="mailto:skaar@bigfoot.com" target="_blank">Vevmester</a> | <a href="javascript:Favourite();">Lagre 
      som favoritt</a></font>
      <?PHP
      	echo ("\n | \n"); 
