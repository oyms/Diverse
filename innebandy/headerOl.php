...
<table background="images/Background4.jpg" width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
  <!--DWLayoutTable-->
  <tr> 
  ...
  <tr> 
    <td width="120">&nbsp;</td>
    <td><font size="+1"><a href="http://www.innebandy.no/spilleregler.asp" target="_top">Regler</a> 
